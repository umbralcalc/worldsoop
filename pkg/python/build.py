# python build stubs for package test_sim
...
mod = Module('_test_sim')
mod.add_include('"test_sim_go.h"')
...
mod.add_function('Slice_Ptr_interactions_AgentConfig_CTor', retval('int64_t'), [])
mod.add_function('Slice_Ptr_interactions_AgentConfig_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_Ptr_interactions_AgentConfig_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_Ptr_interactions_AgentConfig_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_Ptr_interactions_AgentConfig_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_Ptr_interactions_AgentConfig_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('Slice_Ptr_simulator_OtherParams_CTor', retval('int64_t'), [])
mod.add_function('Slice_Ptr_simulator_OtherParams_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_Ptr_simulator_OtherParams_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_Ptr_simulator_OtherParams_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_Ptr_simulator_OtherParams_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_Ptr_simulator_OtherParams_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('Slice_simulator_Iteration_CTor', retval('int64_t'), [])
mod.add_function('Slice_simulator_Iteration_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_simulator_Iteration_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_simulator_Iteration_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_simulator_Iteration_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_simulator_Iteration_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('Map_string_Slice_bool_CTor', retval('int64_t'), [])
mod.add_function('Map_string_Slice_bool_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Slice_bool_elem', retval('int64_t'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_bool_contains', retval('bool'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_bool_set', None, [param('int64_t', 'handle'), param('char*', 'key'), param('int64_t', 'value')])
mod.add_function('Map_string_Slice_bool_delete', None, [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_bool_keys', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Slice_float64_CTor', retval('int64_t'), [])
mod.add_function('Map_string_Slice_float64_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Slice_float64_elem', retval('int64_t'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_float64_contains', retval('bool'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_float64_set', None, [param('int64_t', 'handle'), param('char*', 'key'), param('int64_t', 'value')])
mod.add_function('Map_string_Slice_float64_delete', None, [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_float64_keys', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Slice_int64_CTor', retval('int64_t'), [])
mod.add_function('Map_string_Slice_int64_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Slice_int64_elem', retval('int64_t'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_int64_contains', retval('bool'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_int64_set', None, [param('int64_t', 'handle'), param('char*', 'key'), param('int64_t', 'value')])
mod.add_function('Map_string_Slice_int64_delete', None, [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Slice_int64_keys', retval('int64_t'), [param('int64_t', 'handle')])
add_checked_function(mod, 'test_sim_StepperOrRunner_ReadyToTerminate', retval('bool'), [param('int64_t', '_handle')])
add_checked_function(mod, 'test_sim_StepperOrRunner_Run', None, [param('int64_t', '_handle'), param('bool', 'goRun')])
add_checked_function(mod, 'test_sim_StepperOrRunner_Step', None, [param('int64_t', '_handle'), param('int64_t', 'wg'), param('bool', 'goRun')])
add_checked_function(mod, 'test_sim_LoadStepperOrRunner', retval('int64_t'), [param('int64_t', 'settings'), param('int64_t', 'implementations'), param('int64_t', 'agents')])
add_checked_function(mod, 'test_sim_RunSimulator', None, [param('bool', 'goRun')])

mod.generate(open('test_sim.c', 'w'))
