...
/* package github.com/worldsoop/worldsoop/pkg/python */
...
extern long long int Slice_Ptr_interactions_AgentConfig_CTor();
extern GoInt Slice_Ptr_interactions_AgentConfig_len(long long int handle);
extern long long int Slice_Ptr_interactions_AgentConfig_elem(long long int handle, GoInt _idx);
extern long long int Slice_Ptr_interactions_AgentConfig_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_Ptr_interactions_AgentConfig_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_Ptr_interactions_AgentConfig_append(long long int handle, long long int _vl);

// --- wrapping slice: []*simulator.OtherParams ---
extern long long int Slice_Ptr_simulator_OtherParams_CTor();
extern GoInt Slice_Ptr_simulator_OtherParams_len(long long int handle);
extern long long int Slice_Ptr_simulator_OtherParams_elem(long long int handle, GoInt _idx);
extern long long int Slice_Ptr_simulator_OtherParams_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_Ptr_simulator_OtherParams_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_Ptr_simulator_OtherParams_append(long long int handle, long long int _vl);
...
extern long long int Slice_simulator_Iteration_CTor();
extern GoInt Slice_simulator_Iteration_len(long long int handle);
extern long long int Slice_simulator_Iteration_elem(long long int handle, GoInt _idx);
extern long long int Slice_simulator_Iteration_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_simulator_Iteration_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_simulator_Iteration_append(long long int handle, long long int _vl);

// --- wrapping map: map[string][]bool ---
extern long long int Map_string_Slice_bool_CTor();
extern GoInt Map_string_Slice_bool_len(long long int handle);
extern long long int Map_string_Slice_bool_elem(long long int handle, char* _ky);
extern char Map_string_Slice_bool_contains(long long int handle, char* _ky);
extern void Map_string_Slice_bool_set(long long int handle, char* _ky, long long int _vl);
extern void Map_string_Slice_bool_delete(long long int handle, char* _ky);
extern long long int Map_string_Slice_bool_keys(long long int handle);

// --- wrapping map: map[string][]float64 ---
extern long long int Map_string_Slice_float64_CTor();
extern GoInt Map_string_Slice_float64_len(long long int handle);
extern long long int Map_string_Slice_float64_elem(long long int handle, char* _ky);
extern char Map_string_Slice_float64_contains(long long int handle, char* _ky);
extern void Map_string_Slice_float64_set(long long int handle, char* _ky, long long int _vl);
extern void Map_string_Slice_float64_delete(long long int handle, char* _ky);
extern long long int Map_string_Slice_float64_keys(long long int handle);

// --- wrapping map: map[string][]int64 ---
extern long long int Map_string_Slice_int64_CTor();
extern GoInt Map_string_Slice_int64_len(long long int handle);
extern long long int Map_string_Slice_int64_elem(long long int handle, char* _ky);
extern char Map_string_Slice_int64_contains(long long int handle, char* _ky);
extern void Map_string_Slice_int64_set(long long int handle, char* _ky, long long int _vl);
extern void Map_string_Slice_int64_delete(long long int handle, char* _ky);
extern long long int Map_string_Slice_int64_keys(long long int handle);
extern char test_sim_StepperOrRunner_ReadyToTerminate(long long int _handle);
extern void test_sim_StepperOrRunner_Run(long long int _handle, char goRun);
extern void test_sim_StepperOrRunner_Step(long long int _handle, long long int wg, char goRun);
extern long long int test_sim_LoadStepperOrRunner(long long int settings, long long int implementations, long long int agents);
extern void test_sim_RunSimulator(char goRun);
